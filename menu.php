...
<html lang="en">
 ...
 <?php
    ...
    for ($i = 1; $i <= 10; $i++){
        echo '<div class = "menu">';
        echo '<a href="?id='.$item_id[$i].'" ><img  id= "'.$item_id[$i].'" src = "'."$img[$i]".'" style=" height:200px; width: 300px"></img></a>';
        echo '<div class = "menu-content">';
        echo '<h4 id=';
        echo $item_id[$i];
        echo 'onclick="show() ">';
        echo " $name[$i] <span>$";
        echo number_format($price[$i], 2, '.', ' ');  
        echo "</span></h4>";
        echo $desc[$i];          
        echo '</div>';
        echo '</div>';
...
echo '<div class="row5" id ="bag">
                <div class="column-12">
                    ...
                    <hr class="divider"></hr>
                    <p id= "addconfirm" style = "font-size:26px; font-weight:bold">Add '.$selected.' to bag?</p>
                    <a href="menu-2.php?id=100" ><button class="btnPO" style="position:relative; top:100%">Add to Bag</button></a>
                    <a href="checkout.php" class="btnPO" )">Check Out</a>';
                   ?>
                </div>
